...
type AviClient struct {
	...
	APIPromotionRequest                      *APIPromotionRequestClient
	APIRateLimitProfile                      *APIRateLimitProfileClient
	APISchema                                *APISchemaClient
	APISpecGenerate                          *APISpecGenerateClient
	APIViolationCorrectionInteractiveRequest *APIViolationCorrectionInteractiveRequestClient
	...
	PatchSystemParams                        *PatchSystemParamsClient
	Pool                                     *PoolClient
	...
	ResumeSeGroupParams                      *ResumeSeGroupParamsClient
	RetentionPolicy                          *RetentionPolicyClient
	Role                                     *RoleClient
	RollbackControllerParams                 *RollbackControllerParamsClient
	RollbackPatchControllerParams            *RollbackPatchControllerParamsClient
	RollbackPatchSeGroupParams               *RollbackPatchSeGroupParamsClient
	RollbackPatchSystemParams                *RollbackPatchSystemParamsClient
	RollbackSeGroupParams                    *RollbackSeGroupParamsClient
	RollbackSystemParams                     *RollbackSystemParamsClient
	...
	SessionKeyForwarder                      *SessionKeyForwarderClient
	...
	UpgradeSystemParams                      *UpgradeSystemParamsClient
	User                                     *UserClient
...
func NewAviClient(host string, username string, options ...func(*session.AviSession) error) (*AviClient, error) {
	...
	aviClient.APIPromotionRequest = NewAPIPromotionRequestClient(aviSession)
	...
	aviClient.APIViolationCorrectionInteractiveRequest = NewAPIViolationCorrectionInteractiveRequestClient(aviSession)
	...
	aviClient.PatchSystemParams = NewPatchSystemParamsClient(aviSession)
	...
	aviClient.ResumeSeGroupParams = NewResumeSeGroupParamsClient(aviSession)
	aviClient.RetentionPolicy = NewRetentionPolicyClient(aviSession)
	aviClient.Role = NewRoleClient(aviSession)
	aviClient.RollbackControllerParams = NewRollbackControllerParamsClient(aviSession)
	aviClient.RollbackPatchControllerParams = NewRollbackPatchControllerParamsClient(aviSession)
	aviClient.RollbackPatchSeGroupParams = NewRollbackPatchSeGroupParamsClient(aviSession)
	aviClient.RollbackPatchSystemParams = NewRollbackPatchSystemParamsClient(aviSession)
	aviClient.RollbackSeGroupParams = NewRollbackSeGroupParamsClient(aviSession)
	aviClient.RollbackSystemParams = NewRollbackSystemParamsClient(aviSession)
	...
	aviClient.SessionKeyForwarder = NewSessionKeyForwarderClient(aviSession)
	...
	aviClient.UpgradeSystemParams = NewUpgradeSystemParamsClient(aviSession)
