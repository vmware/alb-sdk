...
type VcenterDatastore struct {
	...
	// Will be used by default, if not set fallback to datastore_name. Field introduced in 22.1.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
