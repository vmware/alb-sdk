...
type APIEndpointClassificationDetails struct {
	...
	// API Endpoint Classification details. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
