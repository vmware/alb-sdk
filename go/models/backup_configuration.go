...
type BackupConfiguration struct {
	...
	// Bundle Backups are generated by default. When this flag is disabled, JSON backups will be generated. Field introduced in 31.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	BundleMode *bool `json:"bundle_mode,omitempty"`

	// Reference to a FileObject of type KNOWN_HOSTS whose file body is OpenSSH known_hosts file used for host key verification when uploading backups over SFTP or SCP. It is a reference to an object of type FileObject. Field introduced in 32.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	KnownHostsFileRef *string `json:"known_hosts_file_ref,omitempty"`
