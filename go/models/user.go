...
type User struct {
	...
	// Indicates that this local user's password is managed externally (e.g. by VCF/SDDC Manager) rather than by Avi. Field introduced in 32.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
