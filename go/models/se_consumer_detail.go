...
// SeConsumerDetail se consumer detail
// swagger:model SeConsumerDetail
type SeConsumerDetail struct {

	// Assigned SEs. Field introduced in 21.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	AssignedSes []*SeResourceConsumedSummary `json:"assigned_ses,omitempty"`
	...
	// List of ineligible SEs for this VS. Field introduced in 21.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	IneligibleResources []*ConsumerResourceIneligible `json:"ineligible_resources,omitempty"`
	...
	// Summarized placement history. Field introduced in 21.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	PlacementHistoryStrs []string `json:"placement_history_strs,omitempty"`
	...
	StateInfo *SeConsumerWriteOpsInfo `json:"state_info,omitempty"`
	...
	// List of disabled write operations and the corresponding reasons. Field introduced in 21.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	WriteOpDisabledStates []*WriteOpDisabledState `json:"write_op_disabled_states,omitempty"`
}
