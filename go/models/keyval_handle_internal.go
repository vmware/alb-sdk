...
// KeyvalHandleInternal keyval handle internal
// swagger:model KeyvalHandleInternal
type KeyvalHandleInternal struct {
	...
	NumPendingDistribute *uint32 `json:"num_pending_distribute,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	NumRedisBadKey *uint32 `json:"num_redis_bad_key,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	NumRedisBadVal *uint32 `json:"num_redis_bad_val,omitempty"`
	...
	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SslSessionCacheInternal []*SSLSessionCacheInternal `json:"ssl_session_cache_internal,omitempty"`
}
