...
type TechSupportState struct {
	...
	// Descriptive reason for the tech-support state-change. Field introduced in 31.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
