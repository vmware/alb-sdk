...
type DiscriminatorDescription struct {
	...
	// Property name of the discriminator. Field introduced in 32.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
