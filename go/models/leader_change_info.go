...
type LeaderChangeInfo struct {
	...
	// Leader change mode, can be auto or manual. Enum options - GSLB_LC_MODE_MANUAL, GSLB_LC_MODE_AUTO. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LeaderChangeMode *string `json:"leader_change_mode,omitempty"`

	// Maximum number of probe failures before considering other site as down for auto leader change. Allowed values are 1-3600. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
