...
type ControllerSizingLimits struct {
	...
	// Maximum number of Serviceengine with realtime metrics enabled. Field introduced in 31.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Number of virtualservices with both real-time metrics and WAF enabled together. Field introduced in 31.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum number of virtualservices configured with WAF. Field introduced in 30.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
