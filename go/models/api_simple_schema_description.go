...
type APISimpleSchemaDescription struct {
	...
	// Maximum allowed value for integer and number types (inclusive by default). Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MaxValue *float64 `json:"max_value,omitempty"`

	// Minimum allowed value for integer and number types (inclusive by default). Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	MinValue *float64 `json:"min_value,omitempty"`

	// Reference to the ApiSchema object. Used when type is SCHEMA_TYPE_REFERENCE, equivalent to $ref in OpenAPI. It is a reference to an object of type ApiSchema. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SchemaRef *string `json:"schema_ref,omitempty"`

	// If set, this is a list of all possible values for this string. Field introduced in 32.1.4. Maximum of 1024 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Maximum allowed length for *string values. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	StringMaxLength *uint32 `json:"string_max_length,omitempty"`

	// Minimum allowed length for *string values. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	StringMinLength *uint32 `json:"string_min_length,omitempty"`

	// If set, this is a regular expression which must match the string. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
