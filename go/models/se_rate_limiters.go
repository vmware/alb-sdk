...
type SeRateLimiters struct {
	...
	// Rate limiter for ND packets in pps. Field introduced in 31.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
