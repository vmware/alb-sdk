...
type BuildInfo struct {
	...
	// Remote reference of the container image. Field deprecated in 31.1.1. Field introduced in 30.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
