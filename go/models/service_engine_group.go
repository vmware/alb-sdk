...
type ServiceEngineGroup struct {
	...
	// Use to cap the size of debug ring min(se_debug_trace_sz, num_dispatcher_cores). Only applicable to > 8G systems.  Requires SE Reboot. Allowed values are 1,2,4,8. Field introduced in 22.1.6. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	SeDebugTraceSz *int32 `json:"se_debug_trace_sz,omitempty"`
