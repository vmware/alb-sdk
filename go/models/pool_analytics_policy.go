...
type PoolAnalyticsPolicy struct {
	...
	// Settings to turn on realtime metrics and set duration for realtime updates. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
