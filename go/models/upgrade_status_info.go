...
type UpgradeStatusInfo struct {
	...
	// Remote image reference of previous base image. Field deprecated in 31.1.1. Field introduced in 30.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	...
	// Remote image reference of current base image. Field deprecated in 31.1.1. Field introduced in 30.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
