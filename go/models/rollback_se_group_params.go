...
// RollbackSeGroupParams rollback se group params
// swagger:model RollbackSeGroupParams
type RollbackSeGroupParams struct {
	...
	// SE Group uuids for applying rollback operations. It is a reference to an object of type ServiceEngineGroup. Field introduced in 18.2.6. Minimum of 1 items required. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
