...
type APIRequestBodyDescription struct {
	...
	// Description of the request body from the OpenAPI specification. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Mapping of the content type to the request body schema. Field introduced in 32.1.4. Maximum of 128 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Mappings []*APIContentTypeMapping `json:"mappings,omitempty"`

	// Marks the request body as required. A missing body is treated as a violation; enforcement depends on the configured body validation actions. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
