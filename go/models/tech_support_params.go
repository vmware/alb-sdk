...
type TechSupportParams struct {
	...
	// Collect events based on duration, specify one from choices [m, h, d, w].i.e. minutes, hours, days, weeks. e.g. 10m, 5h, 2d, 1we.g. show tech-support debuglogs duration 30m. Field introduced in 18.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Tech-support collection level. Field introduced in 18.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Specify pattern to collect specific info in tech-support.User can specify error patterns to filter files based on pattern only. This way will reduce unnecessary collection. Field introduced in 31.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	...
	// Tech-support collection slug; Typically uuid of a vs, gslb etc. Field introduced in 18.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Slug *string `json:"slug,omitempty"`

	// Start timestamp of tech-support collection. Field introduced in 18.2.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
