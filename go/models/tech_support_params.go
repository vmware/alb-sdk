...
type TechSupportParams struct {
	...
	// Specify this params to set threshold for all event files. User provided parameters will take precedence over the profile parameters. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Name of the objects like service engine, vs, pool etc. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Name *string `json:"name,omitempty"`

	// Specify pattern to collect specific info in techsupport. User can specify error patterns to filter files based on pattern only. This way will reduce unnecessary collection. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Pattern *string `json:"pattern,omitempty"`

	// Use this flag for skippable warnings. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// X-Avi-Tenant of HTTP POST request for authentication. Always admin for now, can be override in the future. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
