...
type SeRuntimeProperties struct {
	...
	// Interval in seconds at which log-agent checks RSS against the trim threshold. Allowed values are 10-3600. Field introduced in 32.1.3. Unit is SECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
