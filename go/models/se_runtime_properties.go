...
type SeRuntimeProperties struct {
	...
	// RSS threshold in MB beyond which log-agent invokes malloc_trim(0). Set to 0 to disable the periodic RSS monitor entirely. SIGUSR1 always triggers a trim regardless of this setting. Allowed values are 0-1024. Field introduced in 32.2.1. Unit is MB. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Interval in seconds at which log-agent checks RSS against the trim threshold. Allowed values are 10-3600. Field introduced in 32.2.1. Unit is SECONDS. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
