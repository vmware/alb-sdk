...
type GslbGeoDbEntry struct {
	...
	// This is referred to FileObject that is associtated with the giveb geodb profile. It is a reference to an object of type FileObject. Field introduced in 31.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
