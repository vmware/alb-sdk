...
type VIMgrGuestNicRuntime struct {
	...
	// NSX segment port path for TEPless VPC mode. This port is pre-created before VNIC attachment. Field introduced in 32.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	NsxSegmentPortPath *string `json:"nsx_segment_port_path,omitempty"`

	//  Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	OsPortUUID *string `json:"os_port_uuid,omitempty"`

	// Segment port of the vnic assigned to SE. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
