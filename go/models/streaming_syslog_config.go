...
type StreamingSyslogConfig struct {
	...
	// As per RFC, Constant *string to identify the type of message. Field introduced in 22.1.5. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	...
	// As per RFC, if there is a change in value indicated there has been discontinuity in syslog reporting. Field introduced in 22.1.5. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
