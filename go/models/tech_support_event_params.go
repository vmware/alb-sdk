...
type TechSupportEventParams struct {
	...
	// Collect all events agnostic of duration, days and files.This flag will have higher precedence over duration, files and daysIf flag is false then precedence given to duration passed while invocation. Field introduced in 31.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
