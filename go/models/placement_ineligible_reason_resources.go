...
// PlacementIneligibleReasonResources placement ineligible reason resources
// swagger:model PlacementIneligibleReasonResources
type PlacementIneligibleReasonResources struct {
	...
	// SE UUIDs. Field introduced in 21.1.2. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
