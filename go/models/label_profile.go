...
type LabelProfile struct {
	...
	// Description of this label profile. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Description *string `json:"description,omitempty"`

	// Labels available in this profile. Label names must be unique (case-insensitive). Field introduced in 32.1.4. Maximum of 256 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	LabelDefinitions []*Label `json:"label_definitions,omitempty"`

	// Enables logging of WAAP labels effective for a request into ApiLog.effective_labels in the application log. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
