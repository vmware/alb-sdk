...
type APIPolicy struct {
	...
	// List of labels applied to active API endpoints. An active API is an endpoint whose type is API_ACTIVE. Endpoints defined in the policy are active by default. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ActiveAPILabels *APILabels `json:"active_api_labels,omitempty"`

	// API specification metadata extracted from the associated OpenAPI specification. Automatically populated when a FileObject is associated with this policy. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Read Only: true
	APISpecInfo *APISpecInfo `json:"api_spec_info,omitempty"`

	// Description of this API policy. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Description *string `json:"description,omitempty"`

	// Reference to the uploaded OpenAPI specification file associated with this policy. Only one file is supported at a time. It is a reference to an object of type FileObject. Field introduced in 32.1.4. Maximum of 1 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	FileObjectRefs []string `json:"file_object_refs,omitempty"`

	// Mapping of labels to API policy actions. Field introduced in 32.1.4. Maximum of 256 items allowed. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Orphan API Classification settings for this API policy. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	OrphanAPIClassificationSettings *OrphanAPIClassificationSettings `json:"orphan_api_classification_settings,omitempty"`

	// List of labels applied to orphan API endpoints. An orphan API is an endpoint that is specified in the API-Spec but has not been seen in the datapath for a predefined duration. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Server list defining the scope of this API policy. Requests not matching any server URL are treated as non-API traffic. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Validation settings for this API policy. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	ValidationSettings *APIValidationSettings `json:"validation_settings,omitempty"`

	// Zombie API Classification settings for this API policy. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
