...
type TokenRefillRate struct {
	...
	// The rate per refill interval at which tokens are added to the bucket. Allowed values are 1-1000. Field introduced in 31.2.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
	// Required: true
