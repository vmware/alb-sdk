...
type DatascriptCounters struct {
	...
	// This is incremented when datascript attached at L4 Loadbalancing events encounters error. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This is incremented when datascript attached at Server-side SSL Handshake events encounters error. Field introduced in 32.1.4. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
