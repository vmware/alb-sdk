...
type APILog struct {
	...
	// Comma-separated WAAP label names effective for this request. Populated only when the request's LabelProfile has log_labels enabled. Field introduced in 32.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
