...
type CollectionRules struct {
	...
	// Minimum free disk required for report generation in GB. Allowed values are 1-100. Field introduced in 31.2.1. Unit is GB. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
