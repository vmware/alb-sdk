...
type ControllerProperties struct {
	...
	// Time in minutes to wait between consecutive cloud discovery cycles. Allowed values are 1-1440. Field introduced in 30.1.2. Unit is MIN. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	...
	// Time in minutes to wait between consecutive cloud reconcile cycles. Allowed values are 1-1440. Field introduced in 30.1.2. Unit is MIN. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
