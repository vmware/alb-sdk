...
type ControllerProperties struct {
	...
	// Maximum number of POST /api/eventmanager/generateevent requests allowed per minute, across all event_id values. Allowed values are 1-10000. Field introduced in 32.1.3. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
