...
type ControllerProperties struct {
	...
	// Stated time duration beyond which Event manager disregards files whose modified timestamp from current time is later. Allowed values are 1-1800. Field introduced in 30.2.6. Unit is SEC. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
