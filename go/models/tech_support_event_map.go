...
type TechSupportEventMap struct {
	...
	// Duration of tech-support collection. Field introduced in 31.2.1. Unit is SEC. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
