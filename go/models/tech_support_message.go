...
type TechSupportMessage struct {
	...
	// 'Techsupport object ref.'. It is a reference to an object of type TechSupport. Field introduced in 31.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
