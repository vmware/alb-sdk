...
type SeAgentGraphDBNodeConfig struct {
	...
	// Configuration for API Path. Field introduced in 32.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Apipath *APIPath `json:"apipath,omitempty"`

	// Configuration for API Policy. Field introduced in 32.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	Apipolicy *APIPolicy `json:"apipolicy,omitempty"`

	// Configuration for API Schema. Field introduced in 32.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Configuration for Label Profile. Field introduced in 32.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
