...
// SeGroupResumeParams se group resume params
// swagger:model SeGroupResumeParams
type SeGroupResumeParams struct {
	...
	// This field identifies the list of SE groups for which the resume operation is applicable. It is a reference to an object of type ServiceEngineGroup. Field introduced in 18.2.6. Minimum of 1 items required. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
