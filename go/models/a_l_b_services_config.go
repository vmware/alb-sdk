...
type ALBServicesConfig struct {
	...
	// Session configuration data. Field introduced in 30.2.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	...
	// Tenant based configuration data. Field introduced in 30.2.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
