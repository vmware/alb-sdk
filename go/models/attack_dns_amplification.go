...
type AttackDNSAmplification struct {
	...
	// The source port for the DNS query. Field introduced in 21.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
