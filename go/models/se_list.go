...
type SeList struct {
	...
	// IPv6 Floating Interface IPs for the RoutingService. Field introduced in 22.1.6. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
