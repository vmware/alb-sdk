...
type WafRuleOverrides struct {
	...
	// Override the waf mode for this rule. Enum options - WAF_MODE_DETECTION_ONLY, WAF_MODE_ENFORCEMENT. Field introduced in 20.1.6. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
