...
type DiameterLog struct {
	...
	// Field to identify the target server for the message. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	DestinationHost *string `json:"destination_host,omitempty"`

	// Field to identify the realm where receiving server resides. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	DestinationRealm *string `json:"destination_realm,omitempty"`

	// Field to detect duplicate messages. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	EndToEndIdentifier *uint32 `json:"end_to_end_identifier,omitempty"`

	// Field to match requests and responses. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	HopByHopIdentifier *uint32 `json:"hop_by_hop_identifier,omitempty"`

	// Field to identify endpoint that originated the message. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	OriginHost *string `json:"origin_host,omitempty"`

	// Field to identify realm that originated the message. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
