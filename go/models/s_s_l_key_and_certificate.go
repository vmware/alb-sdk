...
type SSLKeyAndCertificate struct {
	...
	//  It is a reference to an object of type CertificateManagementProfile. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Dynamic parameters needed for certificate management profile. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	DynamicParams []*CustomParams `json:"dynamic_params,omitempty"`

	// Enables OCSP Stapling. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Flag to enable Private key import to HSM while importing the certificate. Field introduced in 22.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Configuration related to OCSP. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This is an Internal field to store the OCSP Responder URLs contained in the certificate. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Read Only: true
	OcspResponderURLListFromCerts []string `json:"ocsp_responder_url_list_from_certs,omitempty"`

	// Information related to OCSP response. Field introduced in 20.1.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Read Only: true
	OcspResponseInfo *OCSPResponseInfo `json:"ocsp_response_info,omitempty"`

	// Skip automatic chain selection for the certificate. Not applicable for CA/Intermediate certificate. Field introduced in 32.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	//  Enum options - SSL_CERTIFICATE_TYPE_VIRTUALSERVICE, SSL_CERTIFICATE_TYPE_SYSTEM, SSL_CERTIFICATE_TYPE_CA, SSL_CERTIFICATE_TYPE_CLIENT, SSL_CERTIFICATE_TYPE_SECURE_CHANNEL. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
