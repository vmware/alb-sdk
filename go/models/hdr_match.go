...
type HdrMatch struct {
	...
	// UUID of the *string group(s). It is a reference to an object of type StringGroup. Field introduced in 31.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
