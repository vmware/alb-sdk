...
// UpgradeSeGroupParams upgrade se group params
// swagger:model UpgradeSeGroupParams
type UpgradeSeGroupParams struct {
	...
	// SE Group uuids subjected to upgrade operations. It is a reference to an object of type ServiceEngineGroup. Field introduced in 18.2.6. Minimum of 1 items required. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	// Required: true
