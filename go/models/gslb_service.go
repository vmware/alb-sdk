...
type GslbService struct {
	...
	// If enabled, the SRV target's resolved IP addresses are included in the answer section of the DNS response for a GSLB service of type SRV. Field introduced in 31.1.1. Allowed with any value in Enterprise, Enterprise with Cloud Services edition.
