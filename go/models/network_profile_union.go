...
type NetworkProfileUnion struct {
	...
	// Configure SCTP FastPath network profile. Field introduced in 22.1.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	SctpFastPathProfile *SCTPFastPathProfile `json:"sctp_fast_path_profile,omitempty"`

	// Configure SCTP Proxy network profile. Field introduced in 22.1.3. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Configure UDP Proxy network profile. Field introduced in 17.2.8, 18.1.3, 18.2.1. Allowed with any value in Enterprise, Essentials, Basic, Enterprise with Cloud Services edition.
