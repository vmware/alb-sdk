...
public class AviSDKMockTest {
    ...
    @Test
    public void testAuthenticateSession() throws IOException {
    ...
    public void testPostCall200()
            throws IOException, NoSuchMethodException, SecurityException, AviApiException, org.apache.hc.core5.http.ParseException {
        String content = readFile("InputFile.json", StandardCharsets.UTF_8);
        JSONObject obj = new JSONObject(content);
        JSONObject postInput = (JSONObject) obj.get("postInput");
        String poolstr = postInput.toString();
    ...
    public void testPostCall503()
            throws IOException, NoSuchMethodException, SecurityException, AviApiException {
        String content = readFile("InputFile.json", StandardCharsets.UTF_8);
        JSONObject obj = new JSONObject(content);
        JSONObject postInput = (JSONObject) obj.get("postInput");
        String poolstr = postInput.toString();
    ...
    @Test
    public void testGetCall200() throws IOException, AviApiException, org.apache.hc.core5.http.ParseException {
    ...
    @Test
    public void testGetCall503() throws IOException {
    ...
    @Test
    public void testPostFileUpload() throws org.apache.hc.core5.http.ParseException, IOException, AviApiException {
