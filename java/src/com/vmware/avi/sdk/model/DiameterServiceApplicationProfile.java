...
public class DiameterServiceApplicationProfile  {
    ...
    private Integer maxOutstandingReq = 4098;

    @JsonProperty("req_timeout")
    private Integer reqTimeout = 5;
     ...
     * Field introduced in 31.1.1.
     * Allowed in enterprise edition with any value, enterprise with cloud services edition.
     * Default value when not specified in API or module is interpreted by Avi Controller as 4098.
